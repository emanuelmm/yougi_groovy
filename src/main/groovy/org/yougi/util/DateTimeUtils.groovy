...
class DateTimeUtils {
  ...
  static String getFormattedDate(Date date, String formatDate) {
    if (date == null) {
      return ''
    }
  ...
  static String getFormattedTime(Date time, String formatTime, String timezone) {
    if (time == null) {
      return ''
    }
  ...
  static String getFormattedDateTime(Date dateTime, String formatDateTime, String timezone) {
    if (dateTime == null) {
      return ''
    }
   ...
   * */
  static Date getDate(String date, String dateFormat) throws ParseException {
   ...
   * */
  static Date getDateAndTime(String date, String dateFormat, String time, String timeFormat) throws ParseException {
    SimpleDateFormat formatDate = new SimpleDateFormat(dateFormat)
    SimpleDateFormat formatTime = new SimpleDateFormat(timeFormat)
    mergeDateAndTime(formatDate.parse(date), formatTime.parse(time))
  }
   ...
   * is also null.
   * */
  static Date mergeDateAndTime(Date date, Date time) {
