 ...
 */
@Stateless
class UserAccountBean extends AbstractBean<UserAccount> implements Serializable {
   ...
   */
  boolean existingAccount(String username) {
  ...
  UserAccount findByWebsite(String website) {
    try {
  ...
  UserAccount findByConfirmationCode(String confirmationCode) {
    try {
  ...
  List<UserAccount> findActiveWithPublicProfile() {
   ...
   */
  List<UserAccount> findConfirmedAccounts(Date from, Date to) {
  ...
  List<UserAccount> findAllUnverifiedAccounts() {
  ...
  List<UserAccount> findAllUnconfirmedAccounts() {
  ...
  List<UserAccount> findAllStartingWith(String firstLetter) {
   ...
   */
  List<UserAccount> findAllDeactivatedUserAccounts() {
   ...
   */
  UserAccount findDeactivatedUserAccount(String email) {
    try {
   ...
   */
  List<UserAccount> findInhabitantsFrom(City city) {
  ...
  UserAccount register(UserAccount newUserAccount, Authentication authentication) throws BusinessLogicException {
  ...
  void sendEmailConfirmationRequest(UserAccount userAccount, String serverAddress) throws BusinessLogicException {
  ...
  void sendWelcomeMessage(UserAccount userAccount) {
  ...
  void sendNewMemberAlertMessage(UserAccount userAccount, List<UserAccount> admins) {
  ...
  void markUserAsVerified(UserAccount userAccount) {
    UserAccount existingUser = find(userAccount.getId())
    existingUser.setVerified(Boolean.TRUE)
  }

  void deactivateMembership(UserAccount userAccount, DeactivationType deactivationType) {
  ...
  void sendDeactivationReason(UserAccount userAccount) {
  ...
  void sendDeactivationAlertMessage(UserAccount userAccount, List<UserAccount> admins) {
  ...
  void requestConfirmationPasswordChange(String username, String serverAddress) throws BusinessLogicException {
  ...
  void sendConfirmationCode(UserAccount userAccount, String serverAddress) {
   ...
   */
  void changeEmail(UserAccount userAccount, String newEmail) throws BusinessLogicException {
   ...
   * email address.
   */
  void sendEmailVerificationRequest(UserAccount userAccount, String serverAddress) throws BusinessLogicException {
  ...
  void confirmEmailChange(String confirmationCode) throws BusinessLogicException {
    UserAccount userAccount = findByConfirmationCode(confirmationCode)
    if(!userAccount.getUnverifiedEmail()) {
  ...
  void changePassword(UserAccount userAccount, String password) throws BusinessLogicException {
  ...
  void removeNonConfirmedAccounts(Timer timer) {
